...
<%
    ...
    try {
        ...
        // 신고 이력 확인
        String checkReportSql = "SELECT * FROM report_problem_reply WHERE problem_reply_number = ? AND member_number = ?";
        ...
        if (rs.next()) {
            ...
            String reportSql = "INSERT INTO report_problem_reply (problem_reply_number, member_number, report_date) VALUES (?, ?, CURRENT_TIMESTAMP)";
