...
<%
    ...
    try {
        ...
        // 신고 이력 확인
        String checkReportSql = "SELECT * FROM report_post_comment WHERE post_comment_number = ? AND member_number = ?";
        ...
        if (rs.next()) {
            ...
            String reportSql = "INSERT INTO report_post_comment (post_comment_number, member_number, report_date) VALUES (?, ?, CURRENT_TIMESTAMP)";
