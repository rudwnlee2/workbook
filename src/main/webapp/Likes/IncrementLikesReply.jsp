...
<%
    ...
    try {
        ...
        // 답글 작성자 확인
        String replyAuthorSql = "SELECT member_number FROM problem_reply WHERE problem_reply_number = ?";
        ...
        // 추천 상태 확인 및 변경
        String checkRecommendationSql = "SELECT check_member_recommendations FROM problem_reply_recommendations WHERE problem_reply_number = ? AND member_number = ?";
        ...
        if (rs.next()) {
            ...
            if (checkMemberRecommendations) {
                // 추천 취소
                String updateRecommendationSql = "UPDATE problem_reply_recommendations SET check_member_recommendations = FALSE WHERE problem_reply_number = ? AND member_number = ?";
                ...
                String decrementLikesSql = "UPDATE problem_reply SET number_of_recommendations = number_of_recommendations - 1 WHERE problem_reply_number = ?";
                ...
                // 추천 추가
                String updateRecommendationSql = "UPDATE problem_reply_recommendations SET check_member_recommendations = TRUE WHERE problem_reply_number = ? AND member_number = ?";
                pstmt = conn.prepareStatement(updateRecommendationSql);
                pstmt.setInt(1, replyId);
                pstmt.setInt(2, loggedInMemberNumber);
                pstmt.executeUpdate();
                ...
                String incrementLikesSql = "UPDATE problem_reply SET number_of_recommendations = number_of_recommendations + 1 WHERE problem_reply_number = ?";
            ...
            // 추천 기록이 없는 경우 -> 추천 추가
            String insertRecommendationSql = "INSERT INTO problem_reply_recommendations (problem_reply_number, member_number, check_member_recommendations) VALUES (?, ?, TRUE)";
