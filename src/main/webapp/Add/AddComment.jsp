...
<%
    ...
    if (problemNumberParam == null || userComment == null || problemNumberParam.isEmpty() || userComment.isEmpty()) {
        response.getWriter().write("{\"status\":\"error\", \"message\":\"문제 번호와 댓글 내용을 모두 입력해주세요.\"}");
        return;
    }
    ...
    try {
        ...
        response.getWriter().write("{\"status\":\"error\", \"message\":\"유효한 문제 번호를 입력해주세요.\"}");
        return;
    }
    ...
    try {
        ...
        String insertCommentSql = "INSERT INTO problem_comment (problem_number, member_number, writing_time, comment_content) VALUES (?, ?, NOW(), ?)";
