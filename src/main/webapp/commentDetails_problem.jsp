    ...
    <div class="container">
        <%
            ...
            try {
                ...
                // Create statement
                String sql = "SELECT comment_content, writing_time FROM problem_comment WHERE problem_comment_number = ?";
        ...
        <%
                ...
                out.println("Error: " + e.getMessage()); // Print error message
