    ...
    <div class="container">
        <%
            ...
            try {
                ...
                // Create statement
                String sql = "SELECT comment_content, writing_time FROM problem_reply WHERE problem_reply_number = ?";
                ...
                if (rs.next()) {
                    String replyContent = rs.getString("comment_content");
