...
<%
    ...
    try {
        ...
        // 답글 추천 내역 삭제
        String deleteReplyRecommendationsSql = "DELETE FROM problem_reply_recommendations WHERE problem_reply_number = ?";
        ...
        // 답글 신고 내역 삭제
        String deleteReplyReportSql = "DELETE FROM report_problem_reply WHERE problem_reply_number = ?";
        pstmt = conn.prepareStatement(deleteReplyReportSql);
        pstmt.setInt(1, replyNumber);
        pstmt.executeUpdate();
        pstmt.close();

        // 답글 삭제
        String deleteReplySql = "DELETE FROM problem_reply WHERE problem_reply_number = ? AND member_number = ?";
